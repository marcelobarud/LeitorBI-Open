...
class PowerBIAnalyzer:
    ...
    def is_visible_physical_table(self, table: dict[str, Any]) -> bool:
        return not (
            ...
            or safe_bool(safe_value(table, "isHidden", False))
            or safe_bool(safe_value(table, "isAutoGenerated", False))
        )
    ...
    def count_visible_fields(self, tables: list[dict[str, Any]] | None = None) -> int:
        ...
        return sum(
            ...
            if not safe_bool(safe_value(column, "isHidden", False))
        )
        ...
        return [
            {
                ...
                "Oculta": "Sim" if safe_bool(safe_value(table, "isHidden", False)) else "Não",
        ...
        for table in self.tables_without_technical_dates():
            ...
            for column in safe_list(table, "columns"):
                rows.append({
                    ...
                    "Oculto": "Sim" if safe_bool(safe_value(column, "isHidden", False)) else "Não",
        ...
        for table in self.tables_without_technical_dates():
            ...
            for measure in safe_list(table, "measures"):
                ...
                rows.append({
                    ...
                    "Tabela": table_name,
                    "Oculta": "Sim" if safe_bool(safe_value(measure, "isHidden", False)) else "Não",
    ...
    def relationship_rows(self) -> list[dict[str, Any]]:
        ...
        for relationship in self.relationships:
            ...
            rows.append({
                ...
                "Ativo": "Sim" if safe_bool(safe_value(relationship, "isActive", True), True) else "Não",
